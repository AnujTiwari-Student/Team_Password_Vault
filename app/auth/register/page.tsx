            ...
            <section className="flex-1 relative flex items-center justify-center xs:w-[100%] bg-[#191919] custom-padding">
                ...
                <div className="flex flex-col max-w-[350px] gap-4 w-full">
                    <div className="flex flex-col">
                        <h3 className="text-[#ffffff] text-[24px] font-[400]">Create an account</h3>
                    ...
                    <div className="flex items-center justify-center gap-x-4">
                        ...
                        <span className="text-[#bfbfbf] text-[12px]">OR SIGNUP WITH YOUR EMAIL</span>
                        <div className="border-[#bfbfbf] border-1 w-[74px]"></div>
                    </div>
                    <RegisterForm />
                    <p className="text-xs text-[#939393]">By creating an account you agree to the <span className="underline">Terms of Service</span> and our <span className="underline">Privacy Policy</span>. We will occasionally send you emails about news, products, and services; you can opt-out anytime.</p>
                    <h6 className="text-white">Already have an account ? <span className="text-blue-500 font-semibold"><Link href="/auth/login">Log In</Link></span></h6>
                </div>
            </section>
        </main>
    );
