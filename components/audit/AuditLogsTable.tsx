    ...
    return (
      <div className="space-y-4 md:space-y-6">
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 md:p-12 text-center">
          ...
          <p className="text-gray-400 text-sm md:text-base mt-4">Loading user data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex minimal-scrollbar flex-col sm:flex-row gap-2">          
          <select 
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="px-4 py-2 bg-gray-700 hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg text-sm transition-colors"
            >
              Clear
            </button>
          </div>
      ...
      {loading ? (
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 md:p-12 text-center">
          ...
          <p className="text-gray-400 text-sm md:text-base mt-4">Loading logs...</p>
        </div>
      ) : (
        <>
              ...
              <table className="w-full">
                <thead className="bg-gray-900">
                  <tr className="border-b border-gray-700">
                    ...
                    {isOrgAccount && <th className="text-left py-4 px-6 text-gray-400 font-medium text-sm">IP</th>}
                  </tr>
                </thead>
                <tbody>
                  {logs.map(log => (
                    <tr key={log.id} className="border-b border-gray-700 hover:bg-gray-750 transition-colors">
                      ...
                      {isOrgAccount && <td className="py-4 px-6 text-gray-500 text-xs">{log.ip || '-'}</td>}
                    </tr>
                  ))}
                </tbody>
              </table>
